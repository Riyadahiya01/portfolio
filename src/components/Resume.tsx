          ...
          >
            ...
            <div className="glass-strong rounded-3xl p-7 sm:p-8">
              ...
              <p
                ...
                style={{ color: "var(--text-secondary)" }}
              >
                Download the latest version of my resume or view it in
                fullscreen preview.
              </p>
            ...
            <div className="glass rounded-3xl p-5">
              ...
              >
                ...
                <span style={{ color: "var(--text-primary)" }}>
                  I'll send a role-specific version within 24h.
                </span>
              </p>
            </div>
          </motion.div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="text-right text-xs space-y-0.5 font-mono"
          style={{ color: "var(--text-secondary)" }}
        >
      ...
      <Section title="SUMMARY">
        Research-trained problem solver transitioning into cloud engineering.
        Hands-on with AWS core services, Linux, Networking, Security, CI/CD
        and Infrastructure-as-Code fundamentals. Bias toward documentation,
        automation and least-privilege design.
      </Section>
      ...
      <Section title="EDUCATION">
        <Row
          left="M.Sc. Chemistry"
          right="Postgraduate"
          sub="Research methodology · Technical writing · Analytical thinking"
        />

        <Row
          left="B.Sc. Science"
          right="Undergraduate"
          sub="Scientific method · Quantitative reasoning"
        />
      </Section>
      ...
      <Section title="CORE SKILLS">
        <div
          ...
          style={{ color: "var(--text-secondary)" }}
        >
          AWS (EC2, S3, IAM, VPC, Lambda, CloudWatch, RDS) · Linux · Networking
          · Security fundamentals · GitHub & Git · GitHub Actions · Docker
          basics · Terraform (learning) · CloudWatch monitoring · Documentation
        </div>
      </Section>

      <Section title="SELECTED PROJECTS">
        <Row
          left="Serverless Static Website on AWS"
          right="S3 · CloudFront · ACM · Route 53"
          sub="Private bucket fronted by CloudFront with OAC, custom domain and TLS."
        />

        <Row
          left="Three-Tier VPC Architecture"
          right="VPC · EC2 · RDS · NAT GW"
          sub="Multi-AZ, defense-in-depth, SSM-based access (no bastion)."
        />

        <Row
          left="IAM Least-Privilege Lab"
          right="IAM · Access Analyzer"
          sub="Role-based access, MFA, permission boundaries."
        />
      </Section>
